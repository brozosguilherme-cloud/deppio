...
export default function FaturamentoPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (typeof json.totalRevenue !== "number") {
        setData(null);
        return;
      }
      setData(json);
  ...
  if (!data) return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-500">Nenhum dado de faturamento disponível. Registre sua primeira venda para ver as análises.</p>
      </div>
    </div>
  );
